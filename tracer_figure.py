...
test_stable = exo1.ArrivalProcess(30.0,0.1,500)
test_instable = exo1.ArrivalProcess(5.0,0.1,500)
...
plt.hist(histo1, 50, alpha=0.5, label='stable')
plt.hist(histo2, 50, alpha=0.5, label='unstable')
